    ...
    <div class="container">
        <div class="row gy-4">
            <div class="col-md-4">
                ...
                <p style="font-size:0.9rem;line-height:1.7;">Your one-stop destination for consoles, games, and gaming
                    accessories. Level up your gaming experience.</p>
            ...
            <div class="col-md-2">
                ...
                <ul class="list-unstyled">
                    ...
                    <?php foreach ($categories as $category): ?>
                        <li><a
                                href="/gaming_hub/category.php?id=<?= $category['category_id'] ?>"><?= $category['name'] ?></a>
                        </li>
                    <?php endforeach; ?>
            ...
            <div class="col-md-4">
                ...
                <address style="font-style:normal;font-size:0.9rem;">
                    <p><i class="bi bi-geo-alt me-2" style="color:var(--accent-light)"></i>123 Gaming Street, Kathmandu,
                        Nepal</p>
        ...
        <div class="text-center">
            <p style="font-size:0.8rem;margin:0;">&copy; <?= date('Y') ?> <a href="#" target="_blank">Gaming Hub</a>.
