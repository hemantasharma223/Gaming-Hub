        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex justify-content-between align-items-center border-0 bg-transparent mt-2">
                    <h5 class="mb-0 text-primary fw-bold"><i class="bi bi-cart-check me-2"></i>Pending Orders</h5>
                    <div>
                        <a href="all.php" class="btn btn-sm btn-outline-secondary">View All Orders</a>
                    </div>
                </div>
